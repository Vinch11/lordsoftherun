  ...
  head: () => ({
    meta: [
      ...
      { title: "Conquête — Jeu de course GPS pour l'EPS" },
      {
        name: "description",
        content:
          "Conquête : un Paper.io grandeur nature pour les cours d'EPS. Les équipes courent, ferment leurs boucles GPS et capturent du territoire.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "Conquête" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo+Black&family=Bebas+Neue&family=Barlow:wght@400;500;600;700;900&family=Inter:wght@400;600;700;800;900&family=Space+Grotesk:wght@500;600;700&family=IBM+Plex+Sans:wght@500;600;700&family=IBM+Plex+Mono:wght@500;600;700&family=Baloo+2:wght@600;700;800&family=Nunito:wght@500;600;700;800&display=swap",
      },
