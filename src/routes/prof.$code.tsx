...
function TeacherDashboard() {
    ...
    return (
      <main className="relative h-[100dvh] w-full overflow-hidden bg-black">
        ...
        {/* Broadcast-style vignette so the HUD stays legible over a live map,
            whatever colors happen to be underneath it. The timing tower and
            message button below carry their own dark backing instead, like a
            real broadcast graphic, so they don't need one here. */}
        ...
        {isOwner && (
          ...
          >
            {overviewMessageOpen ? (
              <div className="panel pointer-events-auto flex w-full max-w-xs flex-col gap-2 p-3">
              ...
              <button
                ...
                className="icon-btn pointer-events-auto h-12 w-12 shrink-0 bg-primary text-primary-foreground shadow-lg"
  ...
  return (
    <main className="flex min-h-screen flex-col lg:h-[100dvh] lg:flex-row lg:overflow-hidden">
      ...
      <div
        className={`mx-auto flex w-full max-w-md flex-1 flex-col gap-5 p-4 lg:mx-0 lg:w-[440px] lg:max-w-[440px] lg:flex-none lg:overflow-y-auto [&>*]:shrink-0 ${panelOpen ? "" : "lg:hidden"}`}
      >
